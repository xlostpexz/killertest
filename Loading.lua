...
_G.Color = Color3.fromRGB(255, 242, 104)

local win = DiscordLib:Window("Blox Fruits", _G.Color, _G.Toggle)

local serv = win:Server("Killer Hub","")

local AutoFarm = serv:Channel("Auto Farm", "http://www.roblox.com/asset/?id=7040391851")
function UpdateTime()
...
local Stats = serv:Channel("Stats", "http://www.roblox.com/asset/?id=7251993295 ")

local TP = serv:Channel("Teleport", "http://www.roblox.com/asset/?id=6022668945 ")
...
Stats:Toggle("Auto Melee", false, function(value)
    _G.Melee = value
...
Stats:Toggle("Auto Defense", false, function(value)
    _G.Defense = value
...
Stats:Toggle("Auto Sword", false, function(value)
    _G.Sword = value
...
Stats:Toggle("Auto Gun", false, function(value)
    _G.Gun = value
...
Stats:Toggle("Auto Devil Fruits", false, function(value)
    _G.DV = value
...
TP:Button("Starter Pirate", function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1102.60156, 16.2701969, 1446.23584, -0.391487002, -0, -0.920183659, -0, 1, -0, 0.920183659, 0, -0.391487002)
wait(0.1)
game.Players.LocalPlayer.Character.Humanoid.Health = 0
end)

TP:Button("Starter Marine", function()
     game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2539.25684, 6.85559702, 2042.26782, 0.169187441, 0, -0.985583961, -0, 1.00000012, -0, 0.985583961, 0, 0.169187441)
wait(0.1)
game.Players.LocalPlayer.Character.Humanoid.Health = 0
end)

TP:Button("Middle Town", function()
     game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-650.985229, 7.85222101, 1571.57654, 0.256446242, 5.89117803e-08, -0.966558516, -1.81054838e-09, 1, 6.04696737e-08, 0.966558516, -1.37572185e-08, 0.256446242)
     wait(0.1)
game.Players.LocalPlayer.Character.Humanoid.Health = 0  
end)
